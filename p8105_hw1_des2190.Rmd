...
The penguins dataset includes the 8 variables: "species", "island", "bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g", "sex", and "year". It includes 344 observations (rows), and, again 8 variables (columns). 
